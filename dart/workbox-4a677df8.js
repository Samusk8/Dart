define("./workbox-4a677df8.js", ["exports"], (function(t) {
    ...
    function k(t) {
        ...
        : function(e, ...s) {
            ...
            return I.set(n, e.sort ? e.sort() : [e]),
            T(n)
        }
    }
    function O(t) {
        return "function" == typeof t ? k(t) : (t instanceof IDBTransaction && function(t) {
            if (L.has(t))
                return;
    ...
    class Y extends v {
        ...
        K() {
            ...
            for (const [s,n] of this.plugins.entries())
                n !== Y.copyRedirectedCacheableResponsesPlugin && (n === Y.defaultPrecacheCacheabilityPlugin && (t = s),
                n.cacheWillUpdate && e++);
